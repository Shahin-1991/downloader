...
## ❤️ با استفاده از این ابزار 
- شما تجاوز غیرقانونی و نظامی آمریکا و اسراییل علیه ایران را محکوم میکنید.
- شما از تمامیت ارضی ایران حمایت میکنید.
- شما روایت های دروغین منتشر شده توسط تبلیغات امریکا و اسراییل را رد میکنید.
